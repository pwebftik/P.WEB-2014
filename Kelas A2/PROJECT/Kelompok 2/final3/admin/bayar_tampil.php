...
<div id="kotak_luar">
	<img src="../images/head.png"  width="1100" height="250" />
		<div id="konten">
            ...
            <p>
                 <a href="bayar_tambah.php"><input type="button" value="Tambah Data Pembayaran" class="styled-button-3>"</a><br></a>
          ...
          <tbody>
              ...
              $no=1;
                    while ($data=mysql_fetch_array($sql)){
                        ...
                        echo '<td><a href="bayar_ubah.php?id='.$data['id'].'">
						<img src="../images/black_edit.gif"></img></a> | <a href="bayar_hapus.php?id='.$data['id'].'" onclick="return confirmSubmit()"><img src="../images/black_delete.png"></img></a></td>';
						echo '</tr>';
                       $no++;
                       } 
              ?>
